...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const CSS = [
			...
			'.mdv-side{width:280px;flex:0 0 280px;border-right:1px solid rgba(127,127,127,.22);overflow:auto;padding:8px 6px;box-sizing:border-box;height:calc(100vh - var(--mdv-reserve));position:sticky;top:0}',
