...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function MarkdownView(props) {
			...
			// Interception is handled by the single document-level capture
			// listener registered in apply(); this component only publishes its
			// nav for that handler to find via [data-mdv-root].
			return React.createElement('div', { className: 'mdv-mdhost' },
